...
function applyTextEvo() {
  ...
  function removeTextEvoBinance(layer){
    ...
    var fx = layer.effect("Text Evo Binance");
    if(fx != null){
        if(fx.matchName == "Pseudo/textevo"){
            fx.remove();
            break;
...
//   }
  ...
  if (!thisComp || !(thisComp instanceof CompItem)){
    ...
    for (i = 0; i < selLayers.length; i++) { // Loop through selected Layer
      ...
      removeTextEvoBinance(selLayers[i])
